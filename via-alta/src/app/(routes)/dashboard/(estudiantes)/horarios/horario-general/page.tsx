...
export default function HorarioGeneralPage() {
  ...
  const DraggableItem = ({ item, index, widthClass }: { item: GeneralScheduleItem, index: number, widthClass: string }) => {
    ...
    return (
      <div
        ...
        className={cn(
          'p-1 text-xs rounded-md border shadow-sm h-full cursor-grab',
